...
public class KraftechProfil {
    ...
    public String toString() {
        ...
        sb.append(KraftechProfil.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
